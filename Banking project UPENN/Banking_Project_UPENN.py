...
def signup(user_accounts, log_in, username, password):
    ...
    - The username already exists in the user_accounts.done
    - The password must be at least 8 characters.done
    - The password must contain at least one lowercase character.done
    - The password must contain at least one uppercase character.done
    - The password must contain at least one number.done
    - The username & password cannot be the same.done
    For example:
    ...
    # your code here
    if username not in user_accounts and valid(password)==True and username!=password:
...
def update(bank, log_in, username, amount):
    ...
    # your code here
    if log_in[username]==True and username not in bank:
        bank[username]=0
        return update(bank, log_in, username, amount)
    if log_in[username]==True:
        if abs(amount)<bank[username] and amount<0:
            bank[username]+= amount
            return True
        elif amount>0:
            bank[username]+= amount
            return True
        elif abs(amount)>bank[username] and amount<0:
            return False
...
def transfer(bank, log_in, userA, userB, amount):
    ...
    # your code here
    if userA in bank and log_in[userA]==True and userB in log_in:
        if bank[userA]-amount<0 or bank[userB]<0:
            return False
        else:
            bank[userA]+= - amount
...
def change_password(user_accounts, log_in, username, old_password, new_password):
    ...
    # your code here
    if username in user_accounts and log_in[username]==True and old_password!=new_password and old_password== user_accounts[username]:
...
def delete_account(user_accounts, log_in, bank, username, password):
    ...
    # your code here
    if username in user_accounts and log_in[username]==True and password == user_accounts[username]:
...
def main():
    ...
    bank = import_and_create_bank("D:\\Python\\Projects\\Banking project UPENN\\bank.txt")
    user_accounts, log_in = import_and_create_accounts("D:\\Python\\Projects\\Banking project UPENN\\user.txt")
